...
'<html lang="en">'.
'	<head>'.
'		<title>REGISTRY - QRS Wedding Planner</title><meta property="og:site_name" content="QRS Wedding Planner" />'.
...
'<meta property="og:url" content="https://qrsweddingpl.weebly.com/registry.html" />'.
''.
''.
''.
...
'		'.
'	</head>'.
'	<body class="no-header-page  wsite-page-registry wsite-theme-light"><div class="wrapper">'.
...
'				<div>'.
'	<form enctype="multipart/form-data" action="//www.weebly.com/weebly/apps/formSubmit.php" method="POST" id="form-583771480730760542">'.
'		<div id="583771480730760542-form-parent" class="wsite-form-container"'.
'				 style="margin-top:10px;">'.
'			<ul class="formlist" id="583771480730760542-form-list">'.
'				<h2 class="wsite-content-title"><font size="6">REGISTER YOUR MARRIAGE HERE</font></h2>'.
''.
...
'				<label class="wsite-form-label">Nama Calon Suami <span class="form-required">*</span></label>'.
'				<div style="clear:both;"></div>'.
'				<div class="wsite-form-input-container wsite-form-left wsite-form-input-first-name">'.
'					<input aria-required="true" id="input-463858411942367972" class="wsite-form-input wsite-input" placeholder="First" type="text" name="_u463858411942367972[first]" />'.
'					<label class="wsite-form-sublabel" for="input-463858411942367972">First</label>'.
'				</div>'.
'				<div class="wsite-form-input-container wsite-form-right wsite-form-input-last-name">'.
'					<input aria-required="true" id="input-463858411942367972-1" class="wsite-form-input wsite-input" placeholder="Last" type="text" name="_u463858411942367972[last]" />'.
'					<label class="wsite-form-sublabel" for="input-463858411942367972-1">Last</label>'.
'				</div>'.
'				<div id="instructions-463858411942367972" class="wsite-form-instructions" style="display:none;">[object Object]</div>'.
'			</div>'.
'			<div style="clear:both;"></div></div>'.
''.
'<div><div class="wsite-form-field wsite-name-field" style="margin:5px 0px 5px 0px;">'.
'				<label class="wsite-form-label">Nama Calon Istri <span class="form-required">*</span></label>'.
'				<div style="clear:both;"></div>'.
'				<div class="wsite-form-input-container wsite-form-left wsite-form-input-first-name">'.
'					<input aria-required="true" id="input-790691972749611128" class="wsite-form-input wsite-input" placeholder="First" type="text" name="_u790691972749611128[first]" />'.
'					<label class="wsite-form-sublabel" for="input-790691972749611128">First</label>'.
'				</div>'.
'				<div class="wsite-form-input-container wsite-form-right wsite-form-input-last-name">'.
'					<input aria-required="true" id="input-790691972749611128-1" class="wsite-form-input wsite-input" placeholder="Last" type="text" name="_u790691972749611128[last]" />'.
'					<label class="wsite-form-sublabel" for="input-790691972749611128-1">Last</label>'.
'				</div>'.
'				<div id="instructions-790691972749611128" class="wsite-form-instructions" style="display:none;"></div>'.
'			</div>'.
'			<div style="clear:both;"></div></div>'.
''.
'<div><div class="wsite-form-field" style="margin:5px 0px 5px 0px;">'.
'				<label class="wsite-form-label" for="input-727508211271178076">Alamat Pasangan <span class="form-required">*</span></label>'.
'				<div class="wsite-form-input-container">'.
'					<input aria-required="true" id="input-727508211271178076" class="wsite-form-input wsite-input wsite-input-width-370px" type="text" name="_u727508211271178076" />'.
'				</div>'.
'				<div id="instructions-727508211271178076" class="wsite-form-instructions" style="display:none;"></div>'.
'			</div></div>'.
''.
'<div><div class="wsite-form-field wsite-phone-field" style="margin-top:5px;">'.
'				<label class="wsite-form-label" for="input-342492420928436545">Nomor HP <span class="form-required">*</span></label>'.
'				<div style="clear:both;"></div>'.
'				<div class="wsite-form-input-container wsite-form-left" style="margin-bottom:5px;">'.
'					<input aria-required="true" id="input-342492420928436545" class="wsite-form-input wsite-input" type="text" name="_u342492420928436545[number]" />'.
'				</div>'.
'				<div id="instructions-342492420928436545" class="wsite-form-instructions" style="display:none;"></div>'.
'			</div>'.
'			<div style="clear:both;"></div></div>'.
''.
'<div><div class="wsite-form-field" style="margin:5px 0px 5px 0px;">'.
'				<label class="wsite-form-label" for="input-314155747737656717">Detail Lengkap <span class="form-required">*</span></label>'.
'				<div class="wsite-form-input-container">'.
'					<textarea aria-required="true" id="input-314155747737656717" class="wsite-form-input wsite-input wsite-input-width-370px" name="_u314155747737656717" style="height: 200px"></textarea>'.
'				</div>'.
'				<div id="instructions-314155747737656717" class="wsite-form-instructions" style="display:none;">Isi data tanggal perencanaan pernikahan, lokasi yang cocok, dan lainnya</div>'.
'			</div></div>'.
'			</ul>'.
'			'.
'		</div>'.
...
'			<input type="hidden" name="ucfid" value="583771480730760542" />'.
...
'		</div>'.
'	</form>'.
'	<div id="g-recaptcha-583771480730760542" class="recaptcha" data-size="invisible" data-recaptcha="0" data-sitekey="6Ldf5h8UAAAAAJFJhN6x2OfZqBvANPQcnPa8eb1C"></div>'.
''.
''.
''.
'</div>'.
