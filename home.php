...
'<html lang="en">'.
'	<head>'.
'		<title>QRS Wedding Planner - HOME</title><meta property="og:site_name" content="QRS Wedding Planner" />'.
'<meta property="og:title" content="QRS Wedding Planner" />'.
'<meta property="og:description" content="Tentang Kami Perusahaan QRS Wedding Planner adalah perusahaan bagian tim QRS Group  yang membantu merencanakan segala hal terkait pernikahan, mulai dari kapan harus dilangsungkan pertemuan dengan..." />'.
'<meta property="og:image" content="https://qrsweddingpl.weebly.com/uploads/1/2/7/7/127767879/qrs-logo-600px-wide.gif" />'.
'<meta property="og:url" content="https://qrsweddingpl.weebly.com/" />'.
''.
''.
''.
...
'	<div  class="wsite-section wsite-header-section wsite-section-bg-image wsite-section-effect-reveal" style="vertical-align: middle;background-image: url(&quot;/uploads/1/2/7/7/127767879/background-images/402763971.png&quot;) ;background-repeat: no-repeat ;background-position: 50% 50% ;background-size: 100% ;background-color: transparent ;background-size: cover;" >'.
...
'        <div class="container">'.
'			<div class="wsite-section-elements">'.
'				<h2 class="wsite-content-title" style="text-align:center;"><font size="6">SELAMAT DATANG DI WEBSITE RESMI<br />&#8203;QRS WEDDING PLANNER</font><br /></h2>'.
''.
'<div class="paragraph"><strong>Tentang Kami</strong><br /><br />Perusahaan QRS Wedding Planner adalah perusahaan bagian tim QRS Group&nbsp;<span style="color:rgb(0, 0, 0)">yang membantu merencanakan segala hal terkait pernikahan, mulai dari kapan harus dilangsungkan pertemuan dengan keluarga, vendor, </span>gladi<span style="color:rgb(0, 0, 0)"> bersih, sampai kapan calon mempelai harus melakukan perawatan sebelum acara pernikahan. Perusahaan ini berdiri pada tanggal 13 Juni 2020 dan memiliki kantor pusat di samping TWA </span>Tangkuban Parahu<span style="color:rgb(0, 0, 0)">, Lembang, Jawa Barat dan kantor cabang yang tersebar di seluruh Indonesia khususnya di Palembang, Jakarta, Pontianak, dan Bali.</span><br /><br />Sekitar 73,7% pasangan mempelai yakin untuk percaya dengan wedding planner dari kami. Mari daftarkan pasangan mempelaimu disini sekarang!</div>'.
''.
'<div class="wsite-spacer" style="height:50px;"></div>'.
''.
'<div class="paragraph"><strong>Produk Kami</strong><br /><br />Kami menyediakan 2 produk terbaik pilihan perusahaan kami untuk calon mempelai Anda. Semua tersedia di kategori Paket Wedding Planner.</div>'.
''.
'<div class="commerce-elements-wrapper categories__published"  data-page-id="900363082506062476" data-page-element-id="401622443461199594">'.
'	<div class="pagination__overlay"></div>'.
'	<div class="commerce-layout-wrapper">'.
'		<div class="product-grid product-grid-columns--1 product-grid-layout--above">'.
'		<div class="product-grid__item">'.
'			<a class="product-grid__item-overlay" href="https://qrsweddingpl.weebly.com/store/c2/Paket_Wedding_Planner.html"></a>'.
'		<div class="product-grid__content">'.
'			<div class="product-grid__info" style="text-align:left">'.
'					<h2 class="product-grid__title">'.
'						<span class="product-grid-reset">Paket Wedding Planner</span>'.
'					</h2>'.
'					<div class="product-grid__button">'.
'						<a href="https://qrsweddingpl.weebly.com/store/c2/Paket_Wedding_Planner.html" class="wsite-button wsite-button-small wsite-button-normal">'.
...
'<div class="wsite-spacer" style="height:50px;"></div>'.
''.
'<div class="paragraph"><strong>Portofolio Kami</strong><br /><br />Anda bisa memeriksa hasil portofolio kami disini</div>'.
''.
'<div style="text-align:left;"><div style="height: 10px; overflow: hidden;"></div>'.
'<a class="wsite-button wsite-button-small wsite-button-normal" href="/portofolio.html" target="_blank">'.
'<span class="wsite-button-inner">PORTFOLIO</span>'.
'</a>'.
'<div style="height: 10px; overflow: hidden;"></div></div>'.
''.
'<div class="wsite-spacer" style="height:50px;"></div>'.
''.
'<div class="paragraph"><strong>Registrasi</strong><br /><br />Jika Anda tertarik dengan kami, silahkan daftarkan pasangan masa depanmu disini</div>'.
''.
'<div style="text-align:left;"><div style="height: 10px; overflow: hidden;"></div>'.
'<a class="wsite-button wsite-button-small wsite-button-normal" href="/registry.html" target="_blank">'.
'<span class="wsite-button-inner">REGISTRATION</span>'.
'</a>'.
'<div style="height: 10px; overflow: hidden;"></div></div>'.
''.
'<div class="wsite-spacer" style="height:50px;"></div>'.
...
'<div class="wsite-spacer" style="height:50px;"></div>'.
''.
'<div class="paragraph" style="text-align:center;">Note : Website ini dibuat untuk memenuhi tugas project UAS Web Programming 1 di Politeknik TEDC Bandung<br /><br />&#8203;Note :&nbsp;This website was created to fulfill the Web Programming 1 Final Exam project assignment at the TEDC Bandung Polytechnic<br /></div>'.
'			</div>'.
'		</div>'.
'      </div>'.
''.
