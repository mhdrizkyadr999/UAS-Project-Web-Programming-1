...
'<html lang="en">'.
'	<head>'.
'		<title>Pemesanan - QRS Wedding Planner</title><meta property="og:site_name" content="QRS Wedding Planner" />'.
'<meta property="og:title" content="Pemesanan" />'.
'<meta property="og:description" content="QRS Wedding Planner" />'.
'<meta property="og:image" content="https://qrsweddingpl.weebly.com/uploads/1/2/7/7/127767879/qrs-logo-600px-wide.gif" />'.
'<meta property="og:url" content="https://qrsweddingpl.weebly.com/pemesanan.html" />'.
''.
''.
''.
...
''.
'		'.
'		<link id="wsite-base-style" rel="stylesheet" type="text/css" href="//cdn2.editmysite.com/css/sites.css?buildTime=1691104854" />'.
'<link rel="stylesheet" type="text/css" href="//cdn2.editmysite.com/css/old/fancybox.css?1689717085" />'.
'<link rel="stylesheet" type="text/css" href="//cdn2.editmysite.com/css/social-icons.css?buildtime=1689717085" media="screen,projection" />'.
'<link rel="stylesheet" type="text/css" href="/files/main_style.css?1689824840" title="wsite-theme-css" />'.
...
'		<script src=\'/files/templateArtifacts.js?1689824840\'></script>'.
'<script>'.
...
''.
'<script type="text/javascript" src="//cdn2.editmysite.com/js/lang/en/stl.js?buildTime=1689717085&"></script>'.
'<script src="//cdn2.editmysite.com/js/site/main.js?buildTime=1691104854"></script><script type="text/javascript">'.
...
'		}'.
'		</script>'.
'		<script type="text/javascript"> _W = _W || {}; _W.securePrefix=\'qrsweddingpl.weebly.com\'; </script><script>_W = _W || {};'.
'			_W.customerLocale = "id";'.
'			_W.storeName = null;'.
'			_W.isCheckoutReskin = false;'.
'			_W.storeCountry = "ID";'.
'			_W.storeCurrency = "USD";'.
'			_W.storeEuPrivacyPolicyUrl = "";'.
'			com_currentSite = "138191747712277170";'.
'			com_userID = "127767879";</script><script type="text/javascript">'.
'								_W = _W || {};'.
'								_W.Commerce = _W.Commerce || {};'.
'								_W.Commerce.hasCart = false;'.
'							</script><script> base_context=\'Site\'; base_name=\'_W\'; ASSETS_BASE=\'cdn2.editmysite.com\'; buildTime=\'1691104854\'</script>'.
''.
...
'		'.
'	</head>'.
'	<body class="no-header-page  wsite-page-pemesanan wsite-theme-light"><div class="wrapper">'.
'    <div class="cento-header">'.
'      <div class="container">'.
'        <div class="logo"><span class="wsite-logo">'.
''.
'	<a href="/">'.
'		<img src="/uploads/1/2/7/7/127767879/qrs-logo-600px-wide.gif" alt="QRS Wedding Planner" />'.
'	</a>'.
''.
'</span></div>'.
...
'		<li id="pg900363082506062476" class="wsite-menu-item-wrap">'.
'			<a'.
'						href="/"'.
'				class="wsite-menu-item"'.
'				>'.
...
'			'.
'		</li>'.
'		<li id="pg349388567163037676" class="wsite-menu-item-wrap">'.
'			<a'.
...
'			'.
'		</li>'.
'		<li id="pg773676086829640461" class="wsite-menu-item-wrap">'.
'			<a'.
'						href="/venue.html"'.
'				class="wsite-menu-item"'.
'				>'.
...
'			'.
'		</li>'.
'		<li id="pg146277607610211509" class="wsite-menu-item-wrap">'.
'			<a'.
'						href="/rsvp.html"'.
'				class="wsite-menu-item"'.
'				>'.
...
'			'.
'		</li>'.
'		<li id="pg563624999982852411" class="wsite-menu-item-wrap">'.
'			<a'.
'						href="/registry.html"'.
'				class="wsite-menu-item"'.
'				>'.
...
'			'.
'		</li>'.
'		<li id="pg654050721563409389" class="wsite-menu-item-wrap">'.
'			<a'.
'						href="/contact.html"'.
'				class="wsite-menu-item"'.
'				>'.
...
'				<div class="commerce-elements-wrapper products__published"  data-page-id="807701340124280645" data-page-element-id="489007418267390038">'.
...
'			<a class="product-grid__item-overlay" href="https://qrsweddingpl.weebly.com/store/p1/Paket_Intimate_1.html"></a>'.
'		<div class="product-grid__content">'.
'						<div class="product-grid__images">'.
'								<div class="product-grid-image image-1 product-grid-image__default product-grid-image-aspect--1-1 js-default-img" style="background-image: url(//cdn2.editmysite.com/images/util/blank-product-w640.png)">'.
'								</div>'.
'						</div>'.
'			<div class="product-grid__info" style="text-align:left">'.
'					<h2 class="product-grid__title">'.
'						<span class="product-grid-reset">Paket Intimate 1</span>'.
'					</h2>'.
...
'						<span class="product-grid-reset product-grid__description--shortened"><p>Paket ini mencakup</p><ul><li> <strong>1. CATERING (100 PAX)</strong></li><li>Nasi</li><li>Aneka Daging Standar</li><li>Aneka Ayam/Ikan Standar</li><li>Cah Sayuran</li><li>Sop</li><li>Kerupuk</li><li>Air Mineral</li></ul><p><br /></p><ul><li> <strong>Dessert :</strong></li><li>Buah Potong</li><li>Puding Fla</li><li>Soft Drink/Matcha Tea</li></ul><p><br /></p><ul><li> <strong>2. MUA &amp; ATTIRE :</strong></li><li>Rias Akad Pengantin</li><li>Busana Akad Pengantin</li><li>Rias &amp; Busana Orang Tua</li><li>Melati Untuk CPP</li><li>Soft Lens</li><li>Hand Bouquet</li></ul><p><br /></p><ul><li> <strong>3. DEKORASI :</strong></li><li>Backdrop Akad 5 Meter</li><li>Lighting Backdrop</li><li>Fresh Flower 3 Titik</li><li>Standing Flower 4 Buah</li><li>Meja Dan Kursi Akad</li><li>Area Penerima Tamu</li><li>Welcome Sign</li></ul><p><br /></p><ul><li> <strong>4. DOKUMENTASI :</strong></li><li>Foto &amp; Video Akad</li><li>Cetak 1 Album Kolase</li><li>Video Liputan &amp; Cinematic</li><li>Soft Copy On DVD</li></ul><p><br /></p><ul><li> <strong>5. MASTER OF CEREMONY :</strong></li><li>MC Akad</li></ul><p><br /></p><ul><li> <strong>6. WEDDING ORGANIZER :</strong></li><li>Pembuatan Rundown Acara</li><li>Person In Charge 4 Orang</li><li>Technical Meeting All Vendors</li><li>Seragam WO &amp; HT</li><li>Hand Sanitizer</li></ul><p><br /></p><ul><li> <strong>7. SOUND SYSTEM :</strong></li><li>Sound System 1000 Watt</li></ul></span>'.
'					</div>'.
'					<div class="product-grid__button">'.
'						<a href="https://qrsweddingpl.weebly.com/store/p1/Paket_Intimate_1.html" class="wsite-button wsite-button-small wsite-button-highlight">'.
...
'	</div>'.
'	<div class="product-grid__item">'.
'			<a class="product-grid__item-overlay" href="https://qrsweddingpl.weebly.com/store/p2/Paket_Intimate_2.html"></a>'.
'		<div class="product-grid__content">'.
'						<div class="product-grid__images">'.
'								<div class="product-grid-image image-1 product-grid-image__default product-grid-image-aspect--1-1 js-default-img" style="background-image: url(//cdn2.editmysite.com/images/util/blank-product-w640.png)">'.
...
'			<div class="product-grid__info" style="text-align:left">'.
'					<h2 class="product-grid__title">'.
'						<span class="product-grid-reset">Paket Intimate 2</span>'.
'					</h2>'.
'					<div class="product-grid__price paragraph">'.
'						<span class="product-grid-reset">'.
...
'					</div>'.
'					<div class="product-grid__description paragraph">'.
'						<span class="product-grid-reset product-grid__description--shortened"><p>Paket ini mencakup:</p><p><br /></p><ul><li> <strong>1. CATERING (150 PAX)</strong></li><li>Nasi</li><li>Aneka Daging Standar</li><li>Aneka Ayam/Ikan Standar</li><li>Cah Sayuran</li><li>Sop</li><li>Kerupuk</li><li>Air Mineral</li><li> <strong>Dessert :</strong></li><li>Buah Potong</li><li>Puding Fla</li><li>Soft Drink/Matcha Tea</li><li> <strong>STALL (75 PAX) :</strong></li><li>Kebab/Zuppa/Aneka Pasta</li><li>Bakso Malang/Mie Kocok/Baso Tahu/Empal Gentong</li><li> <strong>2. MUA &amp; ATTIRE :</strong></li><li>Rias &amp; Busana Akad Pengantin</li><li>Rias &amp; Busana Orang Tua</li><li>Melati Untuk CPP</li><li>Soft Lens</li><li>Hand Bouquet</li><li> <strong>3. DEKORASI :</strong></li><li>Pelaminan 6 Meter</li><li>Lighting Backdrop</li><li>Fresh Flower 3 Titik</li><li>Standing Flower 4 Buah</li><li>Pergola 3×3</li><li>Meja Dan Kursi Akad</li><li>Area Penerima Tamu</li><li>Kotak Angpau 2 Buah</li><li>Welcome Sign</li><li> <strong>4. DOKUMENTASI :</strong></li><li>Foto &amp; Video Akad &amp; Resepsi</li><li>Cetak 1 Album Kolase</li><li>Video Liputan &amp; Cinematic</li><li>Soft Copy On DVD</li><li> <strong>5. MASTER OF CEREMONY :</strong></li><li>MC Akad</li><li>MC Resepsi</li><li> <strong>6. WEDDING ORGANIZER :</strong></li><li>Pembuatan Rundown Acara</li><li>Person In Charge 2-3 Orang</li><li>Family Meeting</li><li>Technical Meeting All Vendors</li><li>Seragam WO &amp; HT</li><li>Hand Sanitizer</li><li> <strong>7. MUSIC &amp; SOUND :</strong></li><li>Musik 3 Personel</li><li>Sound System 1000 Watt</li></ul></span>'.
'					</div>'.
'					<div class="product-grid__button">'.
'						<a href="https://qrsweddingpl.weebly.com/store/p2/Paket_Intimate_2.html" class="wsite-button wsite-button-small wsite-button-highlight">'.
'							<span class="wsite-button-inner">Shop</span>'.
'						</a>'.
'					</div>'.
'			</div>'.
...
'</div>'.
''.
'<script type="text/javascript" src="//cdn2.editmysite.com/js/site/footerSignup.js?buildTime=1691104854"></script>'.
'<script type="text/javascript">'.
'	if (document.readystate === \'complete\') {'.
'		Weebly.footer.setupContainer(\'cdn2.editmysite.com\', \'1691104854\');'.
'	} else {'.
...
'    <script src="//cdn2.editmysite.com/js/site/main-customer-accounts-site.js?buildTime=1691104854"></script>'.
''.
'		<script type="text/javascript">'.
'	var _gaq = _gaq || [];'.
...
'	_W.Analytics.site_id = \'138191747712277170\';'.
''.
